...
#    }, name="home"),
    ...
    url(r"^map/meetings/$", "participation.views.meeting_map_page", name="meeting_map_page"),
    url(r"^map/meetings/(?P<id>\d+)/$", "participation.views.meeting_map_page", name="meeting_map_page"),
