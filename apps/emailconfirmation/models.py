...
class EmailConfirmationManager(models.Manager):
    ...
    def send_confirmation(self, email_address):
        ...
        activate_url = u"http://%s%s" % (unicode(settings.ACTIVE_SITE), path)
        context = {
        ...
        message = EmailMultiAlternatives(subject, message_txt, settings.DEFAULT_FROM_EMAIL, [email_address.email])
